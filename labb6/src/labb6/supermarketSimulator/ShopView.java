...
public class ShopView extends View {
    ...
    private void viewPrinter(ShopState state) {
        if (this.firstCall) {
            ...
            System.out.println("========== \n" +
                    ...
                    "Ankomsthastighet, lambda..: " + Double.toString(state.lambda()) + "\n" +
    ...
    public void infoPrinter(Observable o, Object arg) {
        if (arg instanceof StopEvent) {
        ...
        else if(arg instanceof ShopCloseEvent){
            ...
            System.out.printf("%-10.10s  %-14.16s %-11.11s %-10.10s %-10.10s %-10.10s %-10.10s %-10.10s %-10.10s %-10.10s %-10.10s %-10.10s %-10s",
    ...
    public void update(Observable o, Object arg) {
        ...
        infoPrinter(o, arg); // Denna körs varje gång ett event triggar. Sista körning blir vid stopEvent.
